...
COPY ./.secrets/certs/zato.server05.key.pub.pem /opt/zato/env/server01/zato.server05.key.pub.pem
COPY ./.secrets/certs/zato.server05.key.pem /opt/zato/env/server01/zato.server05.key.pem
COPY ./.secrets/certs/zato.server05.cert.pem /opt/zato/env/server01/zato.server05.cert.pem 
COPY ./.secrets/certs/zato.server06.key.pub.pem /opt/zato/env/server02/zato.server06.key.pub.pem
COPY ./.secrets/certs/zato.server06.key.pem /opt/zato/env/server02/zato.server06.key.pem
COPY ./.secrets/certs/zato.server06.cert.pem /opt/zato/env/server02/zato.server06.cert.pem 
COPY ./.secrets/certs/zato.server07.key.pub.pem /opt/zato/env/server03/zato.server07.key.pub.pem
COPY ./.secrets/certs/zato.server07.key.pem /opt/zato/env/server03/zato.server07.key.pem
COPY ./.secrets/certs/zato.server07.cert.pem /opt/zato/env/server03/zato.server07.cert.pem 
COPY ./.secrets/certs/zato.server08.key.pub.pem /opt/zato/env/server04/zato.server08.key.pub.pem
COPY ./.secrets/certs/zato.server08.key.pem /opt/zato/env/server04/zato.server08.key.pem
COPY ./.secrets/certs/zato.server08.cert.pem /opt/zato/env/server04/zato.server08.cert.pem 
...
COPY ./zato-component/build-zato-image.sh /opt/zato/env/build-zato-image.sh
